...
<body>
    <?php include("includes/header.php");?>
        <h1 style="font-family: calibri; color:black; margin: top 10px;">MEET OUR TEAM</h1>
            <div id = "team">
                <div class="circle"><img src = "assets/images/yash dagur.jpg"/>
                <p class="names1">Yash Dagur</p>
                ...
                <p class="names2">B.Tech CSE</p>
                <p class="names3">201500496</p>
                </div>
                <div class="circle"><img src = "assets/images/kumkum.jpg"/>
